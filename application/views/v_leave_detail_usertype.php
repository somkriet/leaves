			...
			<table id"stable" class="table table-condensed table-hover table-bordered .col-xs-6 .col-md-4">
				...
				<tbody>
					...
					<tr class="active">
						...
						<td><a id="<?php echo $row->leave_ID;?>" onclick="send_leave_id(this.id,'<?php echo $row->subject;?>','<?php echo $row->detail;?>')"><?php
...
function send_leave_id(id,subject,detail){
	...
	$('#detail_table').append('<tr><td width="30%"><b>หมายเลขการลา / Leave ID :</b></td><td width="70%">'+id+'</td></tr>');
    ...
    var rowCount = $('#dtable tr').length;
      ...
      var newth = "<tr><th>ลำดับ/NO</th><th>วันที่/Date</th><th>ตั้งแต่เวลา / Start time</th><th>ถึงเวลา / End Time</th></tr>";
          ...
          $("#myModalLabel").html("Leave Detail");
		})
