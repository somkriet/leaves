															...
															<table class="table table-bordered">
																...
																<?php foreach($data_user as $num=>$row){ ?>
																	<tr>
																		<td>
																			...
																			เบอร์โทร <input type="text" id="phone" name="phone" value="<?php echo $row->phone;?>">
																				...
																				<div class="col-md-4">
																				อีเมลล์ผู้อนุมัติครั้งที่1 <input type="text" id="send_email_to_mgr" name="send_email_to_mgr" size="90" value="<?php echo $row->send_email_to_mgr;?>" style="background: #CCCCCC" readonly>
																				</div>
																				<!-- <br><br> -->
																	...
																	<tr>
																		<td>
																			<div class="col-md-4">
																				อีเมลล์ผู้อนุมัติครั้งที่2 <input type="text" id="send_email_to" name="send_email_to" size="90" value="<?php echo $row->send_email_to;?>" style="background: #CCCCCC" readonly>
																				</div>
																		</td>
																	</tr>
																</tbody>
