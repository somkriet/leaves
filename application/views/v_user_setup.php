		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row form-group">
					...
					<div class="col-md-12">
						<div class="col-md-5">
							<label class="label-control">อีเมลล์ผู้อนุมัติครั้งที่1 /Email Approve 1<font color="red">*</font></label>
							<input id="send_email_to_mgr" name="send_email_to_mgr" type="text" class="form-control" required>
						</div>
						<div class="col-md-offset-2 col-md-5">
							<label class="label-control">อีเมลล์ผู้อนุมัติครั้งที่2 /Email Approve 2</label>
							<input id="send_email_to" name="send_email_to" type="text" class="form-control" >
						</div>
					</div>
				</div>
...
<script type="text/javascript">
			...
			success: function(res){
				...
				setTimeout(function(){
					...
					if(res=='error'){
						...
						$('#send_email_to_mgr').val(res[0]['send_email_to_mgr']);
	...
	$('#myform').on('submit', function(){
		...
		var send_email_to_mgr = $('#send_email_to_mgr').val();
		...
		$.ajax({
			...
			data: {
				...
				'send_email_to_mgr': send_email_to_mgr,
