...
}(function ($) 
{
	...
	DateTimePicker.prototype = {
		...
		_addEventHandlersForInput: function()
		{
			...
			$(oDTP.settings.parentElement).find("input[type='time'], input[type='datetime']").each(function()
			{
			...
			var sel = "[data-field='time'], [data-field='datetime']";
